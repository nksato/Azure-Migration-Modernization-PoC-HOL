...
2. 以下を入力:
   ...
   | サブネット | `AzureMigrateSubnet (10.0.2.0/24)` |
...
# NAT Gateway とサブネットのクリーンアップ
az network vnet subnet update -g rg-onprem --vnet-name vnet-onprem -n AzureMigrateSubnet --remove natGateway -o none
...
az network vnet subnet delete -g rg-onprem --vnet-name vnet-onprem -n AzureMigrateSubnet
```
