...
| 4 | VPN Gateway 配置・接続 | `infra/network/onprem/main.bicep` |
| 5 | ハイブリッド DNS | `infra/network/onprem/Setup-HybridDns.ps1` |
...
詳細は [`1.5-cloud-deploy.md`](./1.5-cloud-deploy.md) を参照してください。
