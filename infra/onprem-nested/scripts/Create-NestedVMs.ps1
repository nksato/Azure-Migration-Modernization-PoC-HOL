...
Write-Host "  az vm disk detach -g rg-onprem-nested --vm-name vm-onprem-nested-hv01 -n disk-upload-ws2022"
Write-Host "  az vm disk detach -g rg-onprem-nested --vm-name vm-onprem-nested-hv01 -n disk-upload-ws2019"
Write-Host "  az disk delete -g rg-onprem-nested -n disk-upload-ws2022 --yes"
Write-Host "  az disk delete -g rg-onprem-nested -n disk-upload-ws2019 --yes"
