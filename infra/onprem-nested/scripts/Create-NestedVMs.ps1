...
Write-Host "  az vm disk detach -g rg-onprem-nested --vm-name vm-onprem-hv01 -n disk-upload-ws2022"
Write-Host "  az vm disk detach -g rg-onprem-nested --vm-name vm-onprem-hv01 -n disk-upload-ws2019"
