        ...
        parts: [
          {
            ...
            metadata: {
              ...
              settings: {
                content: {
                  settings: {
                    content: '# Azure Migration & Modernization PoC\n\n```\nOn-Prem (10.0.0.0/16) ──VPN── Hub (10.10.0.0/16) ──Peering── Spoke1 (10.20.0.0/16) Rehost\n  DC01 / APP01 / DB01           FW / Bastion / VPN GW           Spoke2 (10.21.0.0/16) DB PaaS\n  (3x Standard_D2s_v3)          Log Analytics / DNS Resolver     Spoke3 (10.22.0.0/16) Container\n                                Route Table                     Spoke4 (10.23.0.0/16) Full PaaS\n```'
                    title: ''
                    subtitle: ''
                    markdownSource: 1
                  }
          ...
          }
          {
            ...
            metadata: {
              ...
              settings: {
                content: {
                  settings: {
                    content: '## Hub Resources (rg-hub)\n\n| Resource | Type |\n|----------|------|\n| [afw-hub](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/azureFirewalls/afw-hub/overview) | Firewall Basic |\n| [afwp-hub](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/firewallPolicies/afwp-hub/overview) | Firewall Policy |\n| [bas-hub](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/bastionHosts/bas-hub/overview) | Bastion Basic |\n| [vpngw-hub](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/virtualNetworkGateways/vpngw-hub/overview) | VPN GW VpnGw1AZ |\n| [dnspr-hub](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/dnsResolvers/dnspr-hub/overview) | DNS Private Resolver |\n| [privatelink.database.windows.net](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/privateDnsZones/privatelink.database.windows.net/overview) | Private DNS Zone |\n| [log-hub](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.OperationalInsights/workspaces/log-hub/overview) | Log Analytics |\n| [rt-spokes-to-fw](${portalBase}/resourceGroups/rg-hub/providers/Microsoft.Network/routeTables/rt-spokes-to-fw/overview) | Route Table |'
                    title: ''
                    subtitle: ''
                    markdownSource: 1
                  }
          ...
          // Resource Graph: All PoC resources
          {
            ...
            metadata: {
              ...
              settings: {
                content: {
                  settings: {
                    content: '## Resource Groups\n\n| RG | Purpose | Link |\n|-----|---------|------|\n| rg-hub | Hub (FW/Bastion/VPN GW) | [Open](${portalBase}/resourceGroups/rg-hub/overview) |\n| rg-spoke1 | Spoke1: Rehost | [Open](${portalBase}/resourceGroups/rg-spoke1/overview) |\n| rg-spoke2 | Spoke2: DB PaaS | [Open](${portalBase}/resourceGroups/rg-spoke2/overview) |\n| rg-spoke3 | Spoke3: Container | [Open](${portalBase}/resourceGroups/rg-spoke3/overview) |\n| rg-spoke4 | Spoke4: Full PaaS | [Open](${portalBase}/resourceGroups/rg-spoke4/overview) |\n| rg-onprem | On-Prem (Hyper-V) | [Open](${portalBase}/resourceGroups/rg-onprem/overview) |\n\n[Resource Graph Explorer](https://portal.azure.com/#view/HubsExtension/ArgQueryBlade) - Run custom queries to check all resources'
                    title: ''
                    subtitle: ''
                    markdownSource: 1
                  }
